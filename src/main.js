...
axios.defaults.baseURL = typeof process.env.VUE_APP_LARAVELIP !== 'undefined' ? "http://" + process.env.VUE_APP_LARAVELIP + ":8000/api" : "http://" + process.env.VUE_APP_LARAVELIP + ":8000/api";
